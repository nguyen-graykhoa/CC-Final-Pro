        ...
        <header>
          <Navbar bg="dark" variant="dark" expand="lg">
            <Container>
              ...
              <LinkContainer to="/">
                <Navbar.Brand>Khoa's Vacation Service</Navbar.Brand>
              </LinkContainer>
        ...
        <main>
          <Container className="mt-3">
            <Routes>
              ...
              <Route path="/properties/:slug" element={<PropertyScreen />} />
              <Route path="/cars/:slug" element={<CarScreen />} />
              <Route path="/news/:slug" element={<NewsScreen />} />
              <Route path="/cart" element={<CartScreen />} />
              <Route path="/car" element={<CarHomeScreen />} />
              <Route path="/news" element={<NewsHomeScreen />} />
              <Route path="/property" element={<PropertyHomeScreen />} />
